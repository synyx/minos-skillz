...
public class Zipper {
     ...
     * @throws IOException
     */
    public void writeEntry(InputStream content, String fileName) throws IOException {
    ...
    private void putNextEntry(String filePath) throws IOException {
        ...
        zipOutputStream.putNextEntry(new ZipEntry(FilenameUtils.normalize(baseRelativePath + filePath)));
    }
